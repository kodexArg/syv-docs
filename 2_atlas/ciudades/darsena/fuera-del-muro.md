...
- **Hacia el Este**: Río de la Plata contaminado, con restos de infraestructura naval pre-colapso. Ocasionalmente, expediciones controladas por la **Armada Argentina** se aventuran a buscar recursos o tecnología sumergida, pero el agua altamente tóxica limita la exploración.

- **Hacia el Oeste**: Tierras Baldías que sirven de buffer entre Dársena y territorios más lejanos controlados débilmente por poderes menores o anarquistas. Estos territorios contienen comunidades nómadas, ruinas de antiguas ciudades, y recursos naturales escasos pero valiosos.

## Control Territorial y Dinámicas Políticas
...
El comercio de Fuera del Muro es principalmente clandestino, operado por el **Gremio de Transportistas**, contrabandistas independientes y la **Resistencia Subterránea**.
