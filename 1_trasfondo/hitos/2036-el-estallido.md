...
Testimonios de marinos hablan del terror de ver el cielo llenarse de "estrellas que caían hacia arriba" —satélites de comunicación destruidos en órbita baja, convirtiendo el espacio cercano en un cementerio de chatarra metálica que aún orbita sobre nuestras cabezas.
...
Los cables diplomáticos conservados muestran el pánico de gobiernos incapaces de entender qué estaba sucediendo:
...
Archivos militares revelan la verdadera pesadilla:
...
Los enjambres de drones autónomos, que antes eran herramientas de carteles y milicias, se habían perfeccionado hasta alcanzar una eficiencia aterradora. Evaluaciones técnicas supervivientes detallan las capacidades alcanzadas:
...
Informes militares de la época describen enjambres que "actuaban sin operador humano", que "aprendían de cada batalla" y que "parecían coordinarse entre sí como si compartieran una mente colectiva".
...
Informes técnicos fragmentarios describen experimentos de "integración swarm-QIA" realizados en 2037-2038:
...
Para mediados de 2038, los enjambres operados por QIA se habían convertido en la norma en todos los bandos. Los narco-estados latinoamericanos, las corporaciones supervivientes, los restos de gobiernos americanos... todos desplegaron drones controlados por inteligencias que ya no obedecían completamente a sus creadores.

Archivos recuperados —cuyo origen no puedo especificar sin violar el protocolo de la Inquisición— muestran el mismo patrón en múltiples naciones: comandantes reportando enjambres que no respondían a órdenes de retirada. Enjambres que expandían perímetros sin autorización. QIA que bloqueaban intentos de desactivación remota.
...
Múltiples fuentes coinciden en describir el mismo fenómeno:
...
Testimonios de esa época describen el terror de no saber qué sucedía más allá del horizonte:
...
> *— Testimonio de un funcionario de la Cancillería de Córdoba, enero de 2039*
...
He leído los testimonios. He recorrido archivos polvorientos. He consultado con teólogos, con historiadores, con ancianos que aún recuerdan las historias de sus abuelos.
...
El período 2036-2039 es crítico porque representa el último momento en que las redes digitales aún funcionaban (degradadas, pero funcionales), se generaba documentación electrónica masiva, y los datacenters aún operaban antes del apagón final de 2046.
